...
#pragma endregion
	private:
		void refresh_datagridview()
		{
			...
			this->dataGridView_payment->Columns["id_order"]->Visible = false;

			this->dataGridView_payment->Columns["id_payment"]->Width = 30;
			this->dataGridView_payment->Columns["payment_date"]->Width = 100;
			this->dataGridView_payment->Columns["payment_method"]->Width = 50;
			this->dataGridView_payment->Columns["amount"]->Width = 50;

			this->dataGridView_payment->Columns["id_payment"]->HeaderText = "ID";
			this->dataGridView_payment->Columns["payment_date"]->HeaderText = "Date";
			this->dataGridView_payment->Columns["payment_method"]->HeaderText = "Method";
			this->dataGridView_payment->Columns["amount"]->HeaderText = "Amount";
		}
